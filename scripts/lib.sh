...
load_env() {
  ...
  # Daily cleanup-sessions (./identyclaw.sh cleanup-sessions / enable-session-cleanup).
  # Hard-truncates oversized transcripts (--max-lines) so LLM auto-compaction timeouts cannot wedge chats.
  IDENTYCLAW_SESSION_CLEANUP_TOKEN_FLOOR="${IDENTYCLAW_SESSION_CLEANUP_TOKEN_FLOOR:-50000}"
  IDENTYCLAW_SESSION_CLEANUP_MAX_LINES="${IDENTYCLAW_SESSION_CLEANUP_MAX_LINES:-120}"
  ...
  IDENTYCLAW_SESSION_CLEANUP_ON_CALENDAR="${IDENTYCLAW_SESSION_CLEANUP_ON_CALENDAR:-*-*-* 04:15:00}"
