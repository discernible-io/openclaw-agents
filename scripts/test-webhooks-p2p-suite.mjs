#!/usr/bin/env node
/**
 * Bidirectional P2P webhook suite via send_rodit_webhook (same path peers use on main tier).
 *
 ...
 *     --local-base https://agent-c.dev.identyclaw.com:88 \
 *     --peer-base https://agent-a.dev.identyclaw.com:88 \
