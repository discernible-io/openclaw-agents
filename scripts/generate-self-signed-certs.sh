...
# Env:
#   TLS_CN     Common Name / primary DNS SAN (default: agent-b.identyclaw.com)
#   CERT_DAYS  Validity in days (default: 825)
#   EXTRA_SANS Comma-separated extra SAN entries (e.g. DNS:agent-b.example.com,DNS:agent-d.example.com)
...
TLS_CN="${TLS_CN:-agent-b.identyclaw.com}"
